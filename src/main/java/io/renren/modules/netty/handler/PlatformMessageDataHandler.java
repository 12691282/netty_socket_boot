...
public class PlatformMessageDataHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        if (message == null) {
            log.info("未知警告编码: {}", message);
            this.sendCodeToClient(ctx, Commont.RETURN_ERROR_CODE);
            return;
        }
        //处理逻辑
        //响应客户端
        this.sendCodeToClient(ctx, Commont.RETURN_SUCCESS_CODE);
